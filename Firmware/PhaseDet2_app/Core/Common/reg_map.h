...
#define CONF_PH_ENABLE             0x05000550u  ///< Enable detection
#define CONF_PH_CLEAR_ALL          0x05001550u  ///< Clear all counters
#define CONF_PH_RESERVED           0x05002151u  ///< Reserved
#define CONF_PH_STATE              0x05004051u  ///< Current state of Lines
#define CONF_PH_TOLERANCE          0x05006151u  ///< Tolerance
...
#define PH_STATE_L1                   (1 << (0))
#define PH_STATE_L2                   (1 << (1))
#define PH_STATE_L3                   (1 << (2))
#define PH_STATE_L4                   (1 << (3))
#define PH_STATE_L5                   (1 << (4))
#define PH_STATE_L6                   (1 << (5))
...
#define CONF_DIM_CONDITION ((sizeof(conf_reg_sys_t) != 28) || (sizeof(conf_reg_fact_t) != 16) || (sizeof(conf_reg_firm_t) != 16) || (sizeof(conf_reg_com_t) != 12) || (sizeof(conf_reg_calib_t) != 4) || (sizeof(conf_reg_ph_t) != 8) || (sizeof(conf_reg_dbg_t) != 4) || 0)
