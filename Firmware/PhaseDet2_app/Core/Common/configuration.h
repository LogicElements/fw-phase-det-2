 ...
 * This function takes all registers that need to be stored in flash memory and creates a stream
 ...
 * @param file
 * @param ptr Pointer to the char buffer
