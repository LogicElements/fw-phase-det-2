  ...
  switch (address)
  {
    ...
    case MB_INPUT_SYS_IO_INPUT:
      *value = conf.sys.io_input;
      break;
    case MB_INPUT_SYS_TICK_0:
      *value = *((uint16_t *)CONF_PTR(CONF_SYS_TICK) + 0);
      break;
    case MB_INPUT_SYS_TICK_1:
      *value = *((uint16_t *)CONF_PTR(CONF_SYS_TICK) + 1);
      break;
  ...
  switch (address)
  {
    ...
    case MB_HOLD_SYS_TEST_1:
      *value = *((uint16_t *)CONF_PTR(CONF_SYS_TEST) + 1);
      break;
    case MB_HOLD_SYS_ERROR:
      *value = conf.sys.error;
      break;
    ...
    case MB_HOLD_CALIB_RESERVED:
      *value = conf.calib.reserved;
      break;
    case MB_HOLD_PH_ENABLE:
      *value = conf.ph.enable;
      break;
    case MB_HOLD_PH_CLEAR_ALL:
      *value = conf.ph.clear_all;
      break;
    case MB_HOLD_PH_STATE:
      *value = conf.ph.state;
      break;
    case MB_HOLD_PH_TOLERANCE:
      *value = conf.ph.tolerance;
      break;
...
Status_t MbRtu_WriteHoldingRegCallback(uint16_t address, uint16_t value)
{
  ...
  switch (address)
  {
    ...
    case MB_HOLD_CALIB_RESERVED:
      ...
      break;
    case MB_HOLD_PH_ENABLE:
      conf.ph.enable = (ph_enable_t)value;
      id = CONF_PH_ENABLE;
      break;
    case MB_HOLD_PH_CLEAR_ALL:
      conf.ph.clear_all = (ph_clear_all_t)value;
      id = CONF_PH_CLEAR_ALL;
      break;
    case MB_HOLD_PH_STATE:
      conf.ph.state = value;
      id = CONF_PH_STATE;
      break;
    case MB_HOLD_PH_TOLERANCE:
      conf.ph.tolerance = value;
      id = CONF_PH_TOLERANCE;
      break;
