...
#define MODBUS_UART_ALTERNATE     GPIO_AF7_USART2     ///< MODBUS UART  Alternate function
...
#define MODBUS_TIM_INSTANCE                 TIM16
#define MODBUS_TIM_CLK_ENABLE               __HAL_RCC_TIM16_CLK_ENABLE
