...
#define MB_INPUT_SYS_TICK_0                7u
#define MB_INPUT_SYS_TICK_1                8u
#define MB_INPUT_FACT_SERIAL_NUMBER_0      9u
#define MB_INPUT_FACT_SERIAL_NUMBER_1      10u
#define MB_INPUT_FACT_DEVICE_ID_0          11u
#define MB_INPUT_FACT_DEVICE_ID_1          12u
#define MB_INPUT_FACT_HW_REVISION_0        13u
#define MB_INPUT_FACT_HW_REVISION_1        14u
#define MB_INPUT_FACT_BOOT_REVISION_0      15u
#define MB_INPUT_FACT_BOOT_REVISION_1      16u
#define MB_INPUT_FIRM_REVISION_0           17u
#define MB_INPUT_FIRM_REVISION_1           18u
#define MB_INPUT_FIRM_ASSEMBLY_INFO_0      19u
#define MB_INPUT_FIRM_ASSEMBLY_INFO_1      20u
#define MB_INPUT_FIRM_APP_CHECKSUM_0       21u
#define MB_INPUT_FIRM_APP_CHECKSUM_1       22u
#define MB_INPUT_FIRM_APP_SIZE_0           23u
#define MB_INPUT_FIRM_APP_SIZE_1           24u
#define MB_INPUT_DBG_WRITES_CONF_0         25u
#define MB_INPUT_DBG_WRITES_CONF_1         26u

#define MB_INPUT_LAST     26
...
#define MB_HOLD_SYS_ERROR                  4u
#define MB_HOLD_COM_MB_BAUD_RATE           5u
#define MB_HOLD_COM_MB_PARITY              6u
#define MB_HOLD_COM_MB_STOP_BITS           7u
#define MB_HOLD_COM_MB_APPLY               8u
#define MB_HOLD_COM_MB_TIMEOUT             9u
#define MB_HOLD_CALIB_MODE                 10u
#define MB_HOLD_CALIB_RESERVED             11u
#define MB_HOLD_PH_ENABLE                  100u
#define MB_HOLD_PH_CLEAR_ALL               101u
#define MB_HOLD_PH_STATE                   102u
#define MB_HOLD_PH_TOLERANCE               103u

#define MB_HOLD_LAST      103
